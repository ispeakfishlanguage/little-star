...
_Hero image_
![Background image used for the landing page](./assets/images/hero-image.webp)

_Main color palette_

![Main color Palette](./Documentation/Images/color-palette.png)
...
![Nav Bar](./Documentation/Images/navbar-desktop.png)
...
![Landing Page](./Documentation/Images/hero-image.png)
...
![About Us](./Documentation/Images/about-us-section.png)
...
![Meetup Times](./Documentation/Images/classes-section.png)
...
![Footer](./Documentation/Images/footer-section.png)
...
![Gallery](./Documentation/Images/gallery-section.png)
...
![Join now](./Documentation/Images/join-us-section.png)
...
- Some minor issues with the scaling of the embedded map, it exceeds the viewport by some pixels. Could potentially be solved after learning more about iframe elements and scaling in general.
